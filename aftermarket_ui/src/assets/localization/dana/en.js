export let english = {
    ...
    data: {
        ...
        HEADER: {
            ...
            MENUS: {
                ...
                ADVANCEDSEARCH: {
                    ...
                    SUBMENU: {
                        AUTOMOTIVE: 'AUTOMOTIVE BY YEAR - MAKE - MODEL',
                        INTERCHANGE: 'INTERCHANGE PARTS'
                    }
                }
            }
        },
        FOOTER: {
            DANAHCORP: '2016 Dana Incorporated',
            ABOUT: 'About',
            TERMS: 'Terms of Use',
        ...
        //----------------------part/email-------------------------//
        EMAIL: {
            EMILHEADING: 'Email Part',
            FROM: 'From',
            EMAILID: 'Your Email IDs',
            MANDATORY: '*',
            EMAILREQUIRE: 'Please Enter Your Email ',
            EMAILVALIDATE: 'Please Enter correct Email ID / IDs',
            //EMAILPATTERN: 'Atleast one (.) mandatroy',
            TO: 'To:',
        ...
        PART: {
            ...
            INTERCHANGES_TABLE: {
                COL1: 'Manufacturer',
                COL3: 'Foot Notes',
                COL2: "Manufacturer's Part Number",
                COL4: 'Dana Brand',
                COL5: 'Dana Part Number',
                COL6: 'Product Type',
        ...
        PARTCARD: {
            ...
            CALL: 'Please Contact Dana Helpline number : 1-800-621-8084',
        },
